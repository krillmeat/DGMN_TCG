...
const Frame = ({type,set,formatCard,hasNoInherit=false,isFullArt=false}) => {
  ...
  return (<>
    ...
    <CardArtSVG cardType={cardType} classLabel={classLabel} set={set} formatCard={formatCard} isFullArt={isFullArt}/>
  </>)
}
